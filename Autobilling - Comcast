...
Sub Comcast_Billing()
  ...
  Call titletext(Outputwb, Outputws3, Invoiceno, Region)
  Call titletext(Outputwb, Outputws4, Invoiceno, Region)
  Call titletext(Outputwb, Outputws5, Invoiceno, Region)
  Call titletext(Outputwb, Outputws6, Invoiceno, Region)
  ...
  'Output Worksheet is represented as ow
    ...
    For x = 1 To Count - 1
      ...
      For y = 1 To TotalTask
         valuwewe = sws.Range(dws.Cells(5 + y, 20).Value & x + 1).Value
        'title Column
